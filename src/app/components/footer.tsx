...
export default function Footer(props: { user?: Session['user'] }) {
    return <div className="p-16 flex flex-row items-center justify-center h-72 bg-black text-primary-foreground gap-6 !z-50">
        ...
        <div className='flex flex-col flex-1 h-full'>
            ...
            <Link href="/docs"><Button variant="link" className="p-0 text-primary-foreground"><Book />Documentation</Button></Link>
            <Link href="/explore"><Button variant="link" className="p-0 text-primary-foreground"><Compass />Explore</Button></Link>
